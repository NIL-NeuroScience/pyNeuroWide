...
# %%
def preprocessing(path: str, rotation: int):
    # %% organize files
    ...
    for i, Run in enumerate(all_runs):
        ...
        if dataIn[i]["behavior"]:
            ...
            if flag_behavior_mp4:
                ...
                tifffile.imwrite(path_behavior + ".tif", beh_camera, compression="zlib")
                # io.video_compression(beh_camera, output=path_behavior + ".mp4")

                print("\tLoading compressed behavior images")
                comp_beh_camera = tifffile.imread(path_behavior + ".tif")
...
if __name__ == "__main__":
    ...
    preprocessing(args.path, args.rotation)